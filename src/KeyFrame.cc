...
KeyFrame::KeyFrame():
        ...
        mnTrackReferenceForFrame(0), mnFuseTargetForKF(0), mnBALocalForKF(0), mnBAFixedForKF(0), mnBASPDForKF(0), mnBALocalForMerge(0),
...
void KeyFrame::GetDepthMat(cv::Mat& depthMat)
{
    // TODO lock?
    depthMat = mDepthMat.clone();
}

void KeyFrame::GetDepthMatRef(cv::Mat& depthMat)
{
    depthMat = mDepthMat;
}

void KeyFrame::SetDepthMat(const cv::Mat& depthMat)
{
