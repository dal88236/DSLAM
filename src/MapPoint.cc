...
MapPoint::MapPoint():
    ...
    mnLastFrameSeen(0), mnBALocalForKF(0), mnFuseCandidateForKF(0), mnBASPDForKF(0), mnLoopPointForKF(0), mnCorrectedByKF(0),
...
MapPoint::MapPoint(const Eigen::Vector3f &Pos, Map* pMap, Frame* pFrame, const int &idxF):
    ...
    mnBALocalForKF(0), mnFuseCandidateForKF(0), mnBASPDForKF(0),mnLoopPointForKF(0), mnCorrectedByKF(0),
